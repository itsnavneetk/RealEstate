...
{
    public partial class Residential_sale : Form
    {
        public int sess;
        public Residential_sale(int sess1)
        {
            sess = sess1;
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (address != null && price != null && sq != null && storage != null)
            {
                ...
                conn.Open();
                SqlDataAdapter sda = new SqlDataAdapter("INSERT INTO commercial_unit (pr_id, furnished, price) values ('23','" + sq + "','" + price + "')", conn);
                sda.SelectCommand.ExecuteNonQuery();

                SqlDataAdapter sda1 = new SqlDataAdapter("INSERT INTO property (owner_id, address) values ('" + sess + "','" + address + "')", conn);
                sda1.SelectCommand.ExecuteNonQuery();

                SqlDataAdapter sda11 = new SqlDataAdapter("INSERT INTO sale_unit (pr_id, price) values ('23','" + storage + "')", conn);
